...
public class HistoryTrendPluginTest {
    ...
    public void shouldGetData() throws Exception {
        ...
        final List<HistoryTrendItem> data = new HistoryTrendPlugin(historyTrendManager).getData(createSingleLaunchResults(
    ...
    public void shouldFindLatestExecutor() throws Exception {
        ...
        final List<HistoryTrendItem> data = new HistoryTrendPlugin(historyTrendManager).getData(launchResults);
